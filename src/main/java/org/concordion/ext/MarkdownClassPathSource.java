...
public class MarkdownClassPathSource implements Source {
    ...
    PegDownPlugins plugins = new PegDownPlugins.Builder().withInlinePluginRules(mpp.ConcordionEqualsPlugin(), mpp.ConcordionSetRule()).build(); //Plugin(MyPluginParser.class, null).build();
