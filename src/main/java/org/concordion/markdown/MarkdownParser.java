...
public class MarkdownParser {
    ...
    private PegDownPlugins plugins = new PegDownPlugins.Builder().withInlinePluginRules(
            mpp.concordionEqualsRule(),
            mpp.concordionSetRule(),
            mpp.concordionExecuteRule()
    ).build(); //Plugin(MyPluginParser.class, null).build();
