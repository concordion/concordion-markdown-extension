...
public class ConcordionStatementParserTest {
    private ConcordionStatementParser parser = new ConcordionStatementParser("c", "concordion");

//    @Test
//    public void splitAttributes() {
//        ConcordionStatement statement = parser.splitAttributes("c:a=b n=v", "");
////        assertEquals("a", command.command.name);
//        assertEquals("c:a=b", statement.command.value);
//        assertEquals("n", statement.attributes.get(0).name);
//        assertEquals("v", statement.attributes.get(0).value);
//    }
    ...
    public void shorthandAssertEquals() {
        ...
        assertEquals("concordion:assertEquals", statement.command.name);
