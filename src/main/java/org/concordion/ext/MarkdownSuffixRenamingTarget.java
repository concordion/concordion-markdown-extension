...
public class MarkdownSuffixRenamingTarget implements Target {
	...
	private Resource rename(Resource resource) {
		return new Resource(resource.getPath().replaceFirst("\\." + MarkdownExtension.MARKDOWN_FILE_EXTENSION + "$", "\\.html"));
	}
